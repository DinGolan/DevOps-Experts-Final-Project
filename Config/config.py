...
def get_from_jenkins_arguments():
    ...
    parser.add_argument('-i', '--is_job_run',            default="False" , required=False, choices=["True", "False"]                                         , help="Flag that tells me if Jenkins job is running or not ...")
    ...
    parser.add_argument('-s', '--is_mysql_container'   , default="False" , required=False, choices=["True", "False"]                                         , help="Flag that tells me if we use with DB container (For Docker) or not ...")
    parser.add_argument('-d', '--is_rest_api_container', default="False" , required=False, choices=["True", "False"]                                         , help="Flag that tells me if we use with REST API container or not ...")
    parser.add_argument('-k', '--is_k8s_url'           , default="False" , required=False, choices=["True", "False"]                                         , help="Flag that tells me if we use with K8S URL or not ...")

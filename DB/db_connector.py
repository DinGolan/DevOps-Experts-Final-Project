...
def create_connection_to_db():
    ...
    """
    try:
        connection = pymysql.connect(host=get_db_host(), port=get_db_port(), user=get_from_jenkins_user_argument(), passwd=get_from_jenkins_password_argument(), db=get_db_schema_name())
